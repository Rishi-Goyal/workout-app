...
export interface DungeonSession {
  ...
  /**
   * v4.2.0 Theme D — true when this session was generated by
   * `generateTutorialFloor` for a brand-new user (floorsCleared === 0).
   * Coach-marks gate visibility on this flag together with floorsCleared < 1.
   */
  isTutorial?: boolean;
}
